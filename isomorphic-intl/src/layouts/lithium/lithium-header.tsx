...
import { PiBellSimpleRingingDuotone, PiGearDuotone, PiMagnifyingGlassDuotone } from "react-icons/pi";
    ...
    <div className="ms-auto flex shrink-0 items-center gap-2 text-gray-700 xs:gap-3 xl:gap-4">
      ...
      <NotificationDropdown>
        <ActionIcon
          ...
          variant="text"
          className={cn("relative h-[34px] w-[34px] overflow-hidden rounded-full md:h-9 md:w-9 3xl:h-10 3xl:w-10")}
        >
