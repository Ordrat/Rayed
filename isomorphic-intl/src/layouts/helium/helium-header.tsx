...
import { PiBellSimpleRingingFill, PiGearFill } from "react-icons/pi";
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-2xl items-center">
        <HamburgerButton view={<Sidebar className="static w-full xl:p-0 2xl:w-full [&>div]:xl:rounded-none" />} />
        <Link
          href={"/"}
